...
<body>
	...
	<div class="container">
		...
		<div class="row">
	  		<div class="col-xs-4 col-md-2 "><strong>등록된 계좌정보</strong></div>
		...
		<div class="row">
	  		<div class="col-xs-4 col-md-2 "><strong>은행명</strong></div>
			<div class="col-xs-8 col-md-4">${user.accountBank}</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">${user.accountNo}</div>
		</div>
